    ...
    <div className="app-shell min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="flex flex-col items-center mb-6">
          ...
          <h1 className="text-2xl font-extrabold tracking-tight text-brand-900 dark:text-white">Welcome back</h1>
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Log in to Splitly</p>
        </div>
        ...
        <div className="bg-white/90 dark:bg-slate-900/70 backdrop-blur-sm rounded-2xl shadow-xl shadow-brand-900/5 border border-black/5 dark:border-white/10 p-8">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full rounded-xl bg-gradient-to-r from-brand-500 to-brand-600 hover:from-brand-600 hover:to-brand-700 disabled:opacity-60 text-white text-sm font-semibold py-2.75 py-3 transition-all shadow-md shadow-brand-500/25 hover:shadow-lg hover:shadow-brand-500/30"
            >
